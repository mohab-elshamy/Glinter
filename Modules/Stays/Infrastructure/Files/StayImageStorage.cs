namespace Glinter.Modules.Stays.Infrastructure.Files;

public sealed class StayImageStorage(IWebHostEnvironment environment)
{
    ...
    private string StorageDirectory =>
        Path.Combine(environment.ContentRootPath, "Data", "Uploads", "Stays");
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (file.Length > MaxImageBytes)
            throw new ValidationException("Stay images cannot exceed 5 MB.");
