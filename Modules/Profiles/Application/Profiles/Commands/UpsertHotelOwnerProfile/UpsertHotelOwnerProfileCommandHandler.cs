...
public class UpsertHotelOwnerProfileCommandHandler
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var profile = await _profilesDbContext.HotelOwnerProfiles
            .FirstOrDefaultAsync(x => x.UserId == userId, cancellationToken);

        if (profile is null)
        {
            profile = new HotelOwnerProfile
            {
                Id = Guid.NewGuid(),
                UserId = userId,
            ...
            _profilesDbContext.HotelOwnerProfiles.Add(profile);
        }
        else
        {
