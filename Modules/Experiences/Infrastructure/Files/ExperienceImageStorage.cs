namespace Glinter.Modules.Experiences.Infrastructure.Files;

public sealed class ExperienceImageStorage(IWebHostEnvironment environment)
{
    ...
    private string StorageDirectory =>
        Path.Combine(environment.ContentRootPath, "Data", "Uploads", "Experiences");
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (file.Length > MaxImageBytes)
            throw new ValidationException("Experience images cannot exceed 5 MB.");
