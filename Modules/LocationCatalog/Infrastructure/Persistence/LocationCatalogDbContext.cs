...
public sealed class LocationCatalogDbContext : DbContext, ILocationCatalogDbContext
{
    ...
    public DbSet<DistrictSafetySignal> DistrictSafetySignals => Set<DistrictSafetySignal>();
    public DbSet<Country> Countries => Set<Country>();
    public DbSet<Governorate> Governorates => Set<Governorate>();
    public DbSet<District> Districts => Set<District>();
    public DbSet<Area> Areas => Set<Area>();
    public DbSet<DistrictIndex> DistrictIndices => Set<DistrictIndex>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new DistrictSafetySignalConfiguration());
        modelBuilder.ApplyConfiguration(new DistrictIndexConfiguration());
    }
}